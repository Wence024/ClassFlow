 ...
 * @param {string} user_id - The ID of the user whose class groups to retrieve.
 * @returns {Promise<ClassGroup[]>} A promise that resolves to an array of ClassGroup objects.
 ...
 * @param {ClassGroupInsert} group - The ClassGroupInsert object containing the data for the new group.
 * @returns {Promise<ClassGroup>} A promise that resolves to the newly created ClassGroup object.
 ...
 * @param {string} id - The unique identifier of the class group to update.
 * @param {ClassGroupUpdate} group - The ClassGroupUpdate object containing the fields to update.
 * @returns {Promise<ClassGroup>} A promise that resolves to the updated ClassGroup object.
 ...
 * @param {string} id - The unique identifier of the class group to remove.
