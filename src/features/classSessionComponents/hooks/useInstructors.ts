 ...
 * It fetches all instructors and prioritizes them based on the user's department.
...
export function useInstructors() {
  ...
  return {
    /** The prioritized array of instructors (user's department first, then others). */
