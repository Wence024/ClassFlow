...
import { useScheduleConfig } from '@/features/admin/schedule-config/hooks/useScheduleConfig';
import type { ClassSession } from '@/types/classSession';
import type { HydratedTimetableAssignment, TimetableViewMode } from '../types';
  ...
  const moveClassSessionMutation = useMutation({
    mutationFn: async (variables: {
      ...
      return timetableService.moveClassSession(
        { 
          class_group_id: variables.from.class_group_id, 
          period_index: variables.from.period_index,
          semester_id: activeSemester.id 
        },
        { 
