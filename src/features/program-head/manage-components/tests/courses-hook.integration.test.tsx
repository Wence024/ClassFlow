...
import * as coursesService from '@/features/classSessionComponents/services/coursesService';
...
import type { Course, CourseInsert } from '@/features/classSessionComponents/types/course';
